...
Organization.create(name:"CAMBA LGBT services", telephone:"(929) 305-3000", address: "1259 Flatbush Ave, Brooklyn, NY 11226" , longitude: -73.954530, latitude: 40.639760)
Organization.create(name:"Sunset Park Recreation Center", telephone:"(929) 305-3000", address: "4200 7th Ave, Brooklyn, NY 11232" , longitude: -74.002121, latitude: 40.646931)
Organization.create(name:"恩泉華人浸信會 Chinese Saving Grace Baptist Church", telephone:"(917) 857-6524", address: "6822 20th Ave, Brooklyn, NY 11204" , longitude: -73.988310, latitude: 40.614490)
Organization.create(name:"Father Young Shelter Services", telephone:"(718) 492-2916", address: "140 58th St, Brooklyn, NY 11220" , longitude: -74.023972, latitude: 40.645538)
...
Item.create(name:"Toy Phone", description: "Hello Kitty TOY Phone", image: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.ebay.com%2Fitm%2F392891300802&psig=AOvVaw3tQzaFgxDKkGpBPsRQvSRE&ust=1648902477067000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCKC0scXu8vYCFQAAAAAdAAAAABAE", category: "toys" , user_id: User.all.sample.id, organization_id: Organization.all.sample.id)
Item.create(name:"Children's abacus", description: "Good condition children's counting toy", image: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fpremiumjoy.com%2Fblog%2Fwhere-to-donate-used-toys%2F&psig=AOvVaw3Rp_hJcIOnnbQZ0kEK269S&ust=1648902577927000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCLDFzfru8vYCFQAAAAAdAAAAABAE", category: "toys" , user_id: User.all.sample.id, organization_id: Organization.all.sample.id)
