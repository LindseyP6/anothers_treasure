...
Item.create(name: "Dresser", description: "Wooden dresser", image:"https://www.used.forsale/sh-img/137579703_10159798804663475_1364652713289027237_o_solid%2Bwood%2Bdresser.jpg", category: "furniture", organization_id: Organization.first.id, user_id: User.first.id)
Item.create(name: "Desk", description: "Wooden dresser", image:"https://www.used.forsale/sh-img/137579703_10159798804663475_1364652713289027237_o_solid%2Bwood%2Bdresser.jpg" , category: "furniture" , organization_id: Organization.first.id, user_id: User.second.id)
Item.create(name: "frying pan", description: "Wooden dresser", image:"https://www.used.forsale/sh-img/137579703_10159798804663475_1364652713289027237_o_solid%2Bwood%2Bdresser.jpg" , category: "furniture" , organization_id: Organization.first.id, user_id: User.third.id)
